    ...
    public class WorkersUsagePanel : UsagePanel
    {
        ...
        public override void Start()
        {
            ...
            try
            {
                ...
                AssociateBuildingAI("PloppableRICO.PloppableResidential", UsageType.HouseholdsResidential, (ushort buildingID, ref Building data, ref int used, ref int allowed) => GetUsageCountHouseholds                                (buildingID, ref data, ref used, ref allowed));
                ...
                AssociateBuildingAI("PloppableRICO.PloppableCommercial",  UsageType.WorkersCommercial,     (ushort buildingID, ref Building data, ref int used, ref int allowed) => GetUsageCountWorkersZoned                              (buildingID, ref data, ref used, ref allowed));
                ...
                AssociateBuildingAI("PloppableRICO.PloppableOffice",      UsageType.WorkersOffice,         (ushort buildingID, ref Building data, ref int used, ref int allowed) => GetUsageCountWorkersZoned                              (buildingID, ref data, ref used, ref allowed));
